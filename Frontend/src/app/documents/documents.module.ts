...
@NgModule({
  declarations: [OverviewTableComponent, Anamnese01Component, Testung02Component, Uebersicht00Component, TestungTaskComponent, PatientAutocompleteDialog, TestungChildrenComponent ],
  imports: [
    CommonModule,
    MatTableModule,
    MatSortModule,
