...
namespace kubaapi.Migrations
{
    ...
    [Migration("20190323192105_anamneseadded")]
    partial class anamneseadded
    {
            ...
            modelBuilder.Entity("rl_contract.Models.Anamnese", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountOfPositivAnswers = -1, Date = new DateTime(2019, 3, 23, 20, 21, 5, 261, DateTimeKind.Local), Name = "Anamnese (Fragebogen / Kinder)", PatientId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("rl_contract.Models.Testung", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2019, 3, 23, 20, 21, 5, 255, DateTimeKind.Local), Name = "Erste Testung", PatientId = 1 }
                    );
                });
