...
{
    public partial class QuestionLibAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<string>(
                name: "ExerciseAccomplishment",
                table: "Reviews",
                nullable: true);

            migrationBuilder.AddColumn<string>(
                name: "ObservationsChild",
                table: "Reviews",
                nullable: true);

            migrationBuilder.AddColumn<string>(
                name: "ObservationsParents",
                table: "Reviews",
                nullable: true);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Name", "ReviewId", "Score" },
                values: new object[,]
                {
                    { 1, "I. TESTS ZUR ÜBERPRÜFUNG DER GROBMOTORISCHEN KOORDINAION UND DES GLEICHGEWICHTS", null, null },
                    { 2, "II. TESTS ZUR MOTORISCHEN ENTWICKLUNG", null, null },
                    { 3, "III. TESTS ZUR ÜBERPRÜFUNG VON KLEINHIRNFUNKTIONEN", null, null },
                    { 4, "IV. TESTS ZUR DYSDIADOCHOKINESE", null, null },
                    { 5, "V. LINKS-RECHTS-DISKRIMINIERUNGSPROBLEME", null, null },
                    { 6, "VI. ORIENTIERUNGSPROBLEME", null, null },
                    { 7, "VII. RÄUMLICHE WAHRNEHMUNGSPROBLEME", null, null },
                    { 8, "VIII. TESTS ZU ABERRANTEN REFLEXEN", null, null },
                    { 9, "IX. TESTS ZUR SEITIGKEITSÜBERPRÜFUNG", null, null },
                    { 10, "X. ÜBERPRÜFUNG DER AUGENMUSKELMOTORIK", null, null },
                    { 11, "XI. VISUELLE WAHRNEHMUNGSÜBERPRÜFUNG", null, null },
                    { 12, "ZUSÄTZLICHE BEOBACHTUNGEN UND NOTIZEN", null, null },
                    { 13, "ERGEBNISZUSAMMENFASSUNG", null, null }
                });
