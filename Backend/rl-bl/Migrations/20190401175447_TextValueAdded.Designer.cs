...
namespace kubaapi.Migrations
{
    ...
    [Migration("20190401175447_TextValueAdded")]
    partial class TextValueAdded
    {
            ...
            modelBuilder.Entity("rl_contract.Models.Anamnese", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountOfPositivAnswers = -1, Date = new DateTime(2019, 4, 1, 19, 54, 46, 782, DateTimeKind.Local), Name = "Anamnese (Fragebogen / Kinder)", PatientId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("rl_contract.Models.Testung", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2019, 4, 1, 19, 54, 46, 776, DateTimeKind.Local), Name = "Erste Testung", PatientId = 1 }
                    );
                });
